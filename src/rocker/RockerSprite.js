...
//类型
var RockerType = {};
RockerType.DEFAULT = "DEFAULT";     // 默认放在左下角
RockerType.AUTO = "AUTO";           // 自由移动
RockerType.HIDE = "HIDE";           // 隐藏
RockerType.OPACITY = 255;           // 半透明
...
var Rocker = cc.Sprite.extend({
     ...
     * 构造函数
     * 
     * @param  String baseTexture 底盘纹理
     * @param  String knobTexture 摇杆纹理
     * @param  String type   RockerType
     */
    ctor: function(baseTexture, knobTexture, type){
        ...
        this._loadListener();
        // 加载底盘和摇杆
        this._loadBaseAndKnob(baseTexture, knobTexture);
        // 加载[配置]
     ...
     * @param  String knobTexture 摇杆纹理
     */
    _loadBaseAndKnob : function(baseTexture, knobTexture){
    ...
    _getRadians : function(pos){
        // this.radians = cc.kmDegreesToRadians(this._getAngle(pos));
